...
ClientManager::ClientManager(IOepollManager &io_epoll_manager) : io_epoll_manager(io_epoll_manager) {}
...
void ClientManager::addClient(int socket_fd)
{
    ...
    //by RAII idiom, client object will deallocate the memory when the object got disposed
...
void ClientManager::removeClient(int client_socket_fd)
{
    ...
    client_map.erase(client_socket_fd); // this make the client object to be deallocate automatically
